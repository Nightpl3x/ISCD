...
IMAGE_DIR = os.path.join(ROOT_DIR, "images") # relative path
...
image = skimage.io.imread("D:\Christian_Ohlhäuser\Bildauswertung\ColiChecker\images/0H_10000Z.jpeg") # only use absolute path
# Run detection
...
for i in range(mask.shape[2]):
    temp = skimage.io.imread("D:\Christian_Ohlhäuser\Bildauswertung\ColiChecker\images/0H_10000Z.jpeg")  # only use absolute path
