...
def MRCNN_Coco(IMAGE_DIRECTORY_CAM,images_cam):
    ...
    for i in range(mask.shape[2]):
        ...
        image_name = xct.path_folder_roi+"/"+cam_image_name[last_cam_in_str+7:-5]+"_by_Coco_{}".format(i)+".jpeg" # image name for saving, could use other name template
        plt.savefig(image_name, bbox_inches='tight') # save images to new directory
        #plt.show()


if __name__ == '__main__':
    print ("\nRunning Mask_RCNN_Coco.py by itself won't work on this edition ...")
else:
